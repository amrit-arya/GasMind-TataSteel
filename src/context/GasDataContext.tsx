  ...
  const [auditLogs, setAuditLogs] = useState<AuditItem[]>([
    {
      ...
      category: 'simulation',
      userName: 'Energy Engineer Alpha',
      userDesignation: 'Shift In-Charge / Sr. Energy Engineer',
      userDepartment: 'Energy Management Division (Emp ID: EMP-1001)',
    ...
    },
    {
      ...
      userName: 'Energy Manager Beta',
      userDesignation: 'Chief Energy Manager',
      userDepartment: 'Plant Logistics & Utilities (Emp ID: EMP-1002)',
    ...
    },
    {
      ...
      category: 'simulation',
      userName: 'Process Analyst Gamma',
      userDesignation: 'Principal Process Analyst',
      userDepartment: 'Process Optimization Cell (Emp ID: EMP-1003)',
    ...
    },
    {
      ...
      userName: 'Automation Engineer Delta',
      userDesignation: 'Control Room Controller',
      userDepartment: 'Automation & SCADA Control (Emp ID: EMP-1004)',
